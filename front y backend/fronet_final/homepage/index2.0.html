    ...
    <div class="container-fluid px-4">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link" href="servicios.html">Agenda tu cita</a></li>
...
<div class="modal fade" id="forgotPasswordModal" tabindex="-1" aria-labelledby="forgotPasswordModalLabel" aria-hidden="true">
 ...
 <section class="hero position-relative " id="inicio" >
  <div class="container-fluid">
    <div class="row g-0">
      <div class="col-4">
        <div class="bg-img" style="background-image: url('/imagenes/barbero\ 3.jpg'); height: 100vh; background-size: cover; background-position: center;" data-aos="fade-left"></div>
      </div>
      <div class="col-4">
        <div class="bg-img" style="background-image: url('/imagenes/barbero\ 2.jpg'); height: 100vh; background-size: cover; background-position: center;" data-aos="fade-right"></div>
      </div>
      <div class="col-4">
        <div class="bg-img" style="background-image: url('/imagenes/barbero1.jpg'); height: 100vh; background-size: cover; background-position: center;" data-aos="fade-up"></div>
      </div>
    </div>
    ...
    <div class="cta">
      ...
      <button class="btn-reservar" >
        <a class="text-black" href="servicios.html">Reservar</a></button>
    </div>
  </div>
</section>
  ...
  <div class="container text-center text-white">
    ...
    <div class="row">
      <div class="col-md-4 mb-4" data-aos="">
        <img src="/imagenes/antigua  barber.avif" alt="Experiencia" class="img-fluid rounded shadow" data-aos="fade-left">
        <h5 class="mt-3 fw-bold">+10 Años de Experiencia</h5>
        <p>Formamos estilos que reflejan personalidad, autenticidad y actitud.</p>
      </div>
      <div class="col-md-4 mb-4">
        <img src="/imagenes/equipo barberos.jpg" alt="Nuestro Equipo" class="img-fluid rounded shadow" data-aos="fade-right">
        <h5 class="mt-3 fw-bold">Equipo Profesional</h5>
        <p>Barberos dedicados a brindar atención personalizada y un trato top.</p>
      </div>
      <div class="col-md-4 mb-4">
        <img src="/imagenes/barberi sitio.jpg" alt="Ambiente" class="img-fluid rounded shadow" data-aos="fade-left">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="card bg-dark border-0 h-100 shadow-sm">
          <img src="/imagenes/corte de cabello.jpg" class="card-img-top" alt="Corte de Cabello" data-aos="fade-right">
      ...
      <div class="col-md-4">
        <div class="card bg-dark border-0 h-100 shadow-sm">
          <img src="/imagenes/afeitado.jpg" class="card-img-top" alt="Afeitado Clásico" data-aos="fade-right">
          <div class="card-body" data-aos="fade-left">
      ...
      <div class="col-md-4">
        <div class="card bg-dark border-0 h-100 shadow-sm">
          <img src="/imagenes/barba.jpg" class="card-img-top" alt="Diseño de Barba" data-aos="fade-right">
          <div class="card-body" data-aos="fade-left">
...
<div id="styleCarousel" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner" data-aos="">
    ...
    <div class="carousel-item active position-relative">
      <img src="/imagenes/barbero new.png" class="d-block w-100 carousel-img" alt="barbero 1">
    ...
    <div class="carousel-item position-relative">
      <img src="/imagenes/barbero new2.jpg" class="d-block w-100 carousel-img" alt="barbero 2">
      <div class="carousel-caption-custom">
        <h3>Andres Diaz</h3>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <img src="/imagenes/barbero new3.jpg" class="d-block w-100 carousel-img" alt="barbero 3">
      <div class="carousel-caption-custom">
        <h3>Jose Penagos</h3>
      </div>
    </div>
 ...
 <p style="margin-top: 20px; font-size: 14px; color: #ccc;">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
     ...
     <script src="/javahome/index.js"></script>
</body>
</html>
